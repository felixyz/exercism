...
let tests =
  ...
  ; "detects two anagrams"
    >:: ae ["lemons"; "melons"]
          (anagrams "solemn" ["lemons"; "cherry"; "melons"])
  ...
  ; "words are not anagrams of themselves even if letter case is partially \
     different"
    >:: ae [] (anagrams "BANANA" ["Banana"])
  ; "words are not anagrams of themselves even if letter case is completely \
     different"
    >:: ae [] (anagrams "BANANA" ["banana"])
